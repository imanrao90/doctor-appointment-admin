      ...
      <div className="bg-white px-8 py-8 border border-gray-300 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div>
          ...
          <textarea
            ...
            value={about}
            className="w-full border-gray-200 px-4 pt-2 border rounded"
            placeholder="write about doctor"
            rows={5}
            required
          />

          <button className="bg-blue-500 px-10 py-3 mt-4 text-white rounded-full cursor-pointer">Add Doctor</button>
        </div>
      </div>
    </form>
  )
